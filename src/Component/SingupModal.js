...
// import style from "../Style/modal.modul.css";
  ...
  return (
    <>
      <Modal
        ...
        // className={`pt-7 px-8 pb-9 rounded-2xl ${style}`}
      ...
      >
        <div className=" px-7 py-5">
          <div className="title mb-7 text-center">
            <h1 className="text-center text-[28px] font-['Nunito_Sans'] font-extrabold">
              Register with{" "}
          ...
          <div className="flex gap-6 justify-center items-center h-full">
            <Link to="/student-register">
              <div className="link-hover p-8 flex flex-col items-center min-w-[180px] box-shadow cursor-pointer rounded-2xl">
                <span className="h-[60px] w-[60px] rounded-full bg-yellow-400 flex justify-center items-center">
                  <svg
                    width="28"
                    height="28"
                    viewBox="0 0 28 28"
                ...
                <h4 className="text-black font-semibold text-[18px] font-['Nunito_Sans'] mt-5">
                  Student
                </h4>
              </div>
            </Link>
            <Link to="/teacher-register">
              <div className="link-hover p-8 flex flex-col items-center min-w-[180px] box-shadow cursor-pointer rounded-2xl">
                <span className="h-[60px] w-[60px] rounded-full bg-blue-500 flex justify-center items-center">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
